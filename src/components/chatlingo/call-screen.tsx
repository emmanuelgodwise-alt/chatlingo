...
function RingingScreen({ initials, isVideo }: { initials: string; isVideo: boolean }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-gradient-to-b from-[#075E54] to-[#064E46] flex flex-col items-center justify-center animate-fadeIn">
      ...
      <div className="relative mb-8">
        ...
        {/* Avatar */}
        <div className="relative w-32 h-32 rounded-full bg-[#128C7E] flex items-center justify-center">
          <Avatar className="w-28 h-28">
            <AvatarFallback className="bg-[#128C7E] text-white text-3xl font-semibold">
              {initials}
            </AvatarFallback>
          </Avatar>
        </div>
      ...
      <div className="absolute bottom-16 flex items-center gap-16">
        ...
        <div className="flex flex-col items-center gap-2">
          <button
            ...
            className="w-16 h-16 rounded-full bg-[#25D366] hover:bg-[#1EBE57] flex items-center justify-center shadow-lg transition-colors"
          >
...
function ConnectedCallScreen({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-gradient-to-b from-[#075E54] to-[#064E46] flex flex-col animate-fadeIn">
      ...
      <div className="relative z-10 pt-16 pb-4 flex flex-col items-center">
        ...
        {!isVideo && (
          <div className="w-28 h-28 rounded-full bg-[#128C7E] flex items-center justify-center mb-6">
      ...
      {isVideo && (
        <div className="absolute top-20 right-4 z-20 w-28 h-36 rounded-2xl overflow-hidden shadow-xl border-2 border-white/20">
          ...
          />
          {!callVideoEnabled && (
            <div className="absolute inset-0 bg-[#128C7E] flex items-center justify-center">
